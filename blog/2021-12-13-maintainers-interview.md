...
Did you know that it's already 16 months since the Capact was born?
...
Giving a feedback, requesting a feature, reporting a bug - all of these are a great way to contribute. Just join our [**Slack**](/community/slack) and talk to us! 

Do you participate in [24 Pull Requests](https://24pullrequests.com/) event? We've got your back. Check out issues with the [`good first issue`](https://github.com/capactio/capact/labels/good%20first%20issue) label and get our full support from the beginning to finally merged pull request :)

Do you want work with us on a daily basis? Contact us at [contact@capact.io](mailto:contact@capact.io)!
