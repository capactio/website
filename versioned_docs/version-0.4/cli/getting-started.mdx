...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/v0.4.0/capact-darwin-amd64
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/v0.4.0/capact-linux-amd64
```
...
```shell
curl -Lo capact.exe https://github.com/capactio/capact/releases/download/v0.4.0/capact-windows-amd64.exe
```
...
ghcr.io/capactio/tools/capact-cli:v0.4.0 login $GATEWAY_URL -u $USERNAME -p $PASSWORD
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/v0.4.0/capact-$OS-$ARCH
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/latest/capact-darwin-amd64
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/latest/capact-linux-amd64
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/latest/capact-windows-amd64.exe
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/latest/capact-$OS-$ARCH
```
...
> **NOTE**: This section requires acess to an existing Capact installation. To learn how to install Capact, see the [Installation](../installation/local.md) guides.
