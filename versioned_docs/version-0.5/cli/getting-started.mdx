...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/v0.5.0/capact-darwin-amd64
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/v0.5.0/capact-linux-amd64
```
...
```shell
curl -Lo capact.exe https://github.com/capactio/capact/releases/download/v0.5.0/capact-windows-amd64.exe
```
...
ghcr.io/capactio/tools/capact-cli:v0.5.0 login $GATEWAY_URL -u $USERNAME -p $PASSWORD
```
...
```shell
curl -Lo capact https://github.com/capactio/capact/releases/download/v0.5.0/capact-$OS-$ARCH
```
