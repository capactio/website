...
kubectl set env deployment/capact-hub-public -n capact-system --containers="hub-public-populator" MANIFESTS_PATH="git@github.com:capactio/capact.git?sshkey=${SSH_KEY}&ref=${BRANCH_NAME}"
```
